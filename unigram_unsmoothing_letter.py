...
##    print sum(bigram_letter_counter_test.values())
    ...
    for ngram,value in bigram_letter_counter_test.iteritems():
        ...
        for word in ngram.split():
            actual_list[word]+=1
        result1=test_part(actual_list,order,unigram_unsmoothing_prob1)
        result2=test_part(actual_list,order,unigram_unsmoothing_prob2)
        result3=test_part(actual_list,order,unigram_unsmoothing_prob3)
        result4=test_part(actual_list,order,unigram_unsmoothing_prob4)
