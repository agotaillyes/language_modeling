...
######################################## BACKOFF##########################################
def unigram_prob_tilde(unigram_word_counter,all_word_nr):
...
if __name__ == '__main__':
    ...
    bigram_star = c_star(bigram_word_counter_train)
    bigram_witten_bell = ngram_witten_bell_prob(2,bigram_word_counter_train,unigram_word_counter_train)
    
    unigram_prob_tilde = unigram_prob_tilde(unigram_word_counter_train,all_word_nr)
    bigram_prob_tilde = prob_tilde(bigram_word_counter_train,unigram_word_counter_train,bigram_witten_bell,tokens_nr,all_word_nr,bigram_star)
    
    unigram_alpha = alpha(unigram_prob_tilde,bigram_prob_tilde,unigram_word_counter_train,bigram_word_counter_train)

    bigram_backoff_prob=bigram_backoff(bigram_word_counter_train,unigram_word_counter_train,bigram_prob_tilde,unigram_alpha,all_word_nr)
 
    train_unigram_backoff = train_char_ngram(bigram_backoff_prob,1,bigram_backoff_prob)    
    test_unigram_backoff = test_part(bigram_word_counter_test,1) 
