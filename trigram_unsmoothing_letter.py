...
##    print sum(train_token_list1.values())
##    print sum(train_token_list2.values())
##    print sum(train_token_list3.values())
##    print sum(train_token_list4.values())
##    print sum(test_token_list.values())
    test_result=collections.defaultdict(int)
    
    trigram_unsmoothing_prob1 = ngram_unsmoothing_prob(3,trigram_letter_counter1,bigram_letter_counter1,tokens_nr1)
    trigram_unsmoothing_prob2 = ngram_unsmoothing_prob(3,trigram_letter_counter2,bigram_letter_counter2,tokens_nr2)
    trigram_unsmoothing_prob3 = ngram_unsmoothing_prob(3,trigram_letter_counter3,bigram_letter_counter3,tokens_nr3)
    trigram_unsmoothing_prob4 = ngram_unsmoothing_prob(3,trigram_letter_counter4,bigram_letter_counter4,tokens_nr4)
...
##    print 'ngram: ' + str(ngram_test_nr)
    ...
    for ngram,value in bigram_letter_counter_test.iteritems():
        ...
        for word in ngram.split():
            actual_list[word]+=1
        result1=test_part(actual_list,order,trigram_unsmoothing_prob1)
        result2=test_part(actual_list,order,trigram_unsmoothing_prob2)
        result3=test_part(actual_list,order,trigram_unsmoothing_prob3)
        result4=test_part(actual_list,order,trigram_unsmoothing_prob4)
...
##    print sorted(trigram_unsmoothing_prob1.iteritems(), key=lambda (k,v):v,reverse=True)