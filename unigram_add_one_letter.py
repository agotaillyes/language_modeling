...
if __name__ == '__main__':
    ...
    unigram_add_one_prob1 = ngram_add_one_prob(1,unigram_letter_counter1,unigram_letter_counter1,tokens_nr1,letter_types_nr1)
    unigram_add_one_prob2 = ngram_add_one_prob(1,unigram_letter_counter2,unigram_letter_counter2,tokens_nr2,letter_types_nr2)
    unigram_add_one_prob3 = ngram_add_one_prob(1,unigram_letter_counter3,unigram_letter_counter3,tokens_nr3,letter_types_nr3)
    unigram_add_one_prob4 = ngram_add_one_prob(1,unigram_letter_counter4,unigram_letter_counter4,tokens_nr4,letter_types_nr4)
##    unigram_add_one_prob5 = ngram_add_one_prob(1,unigram_letter_counter5,unigram_letter_counter5,tokens_nr5,letter_types_nr5)
...
##    print sum(bigram_letter_counter_test.values())
    ...
    for ngram,value in bigram_letter_counter_test.iteritems():
        ...
        for word in ngram.split():
            actual_list[word]+=1
        result1=test_part(actual_list,order,unigram_add_one_prob1)
        result2=test_part(actual_list,order,unigram_add_one_prob2)
        result3=test_part(actual_list,order,unigram_add_one_prob3)
        result4=test_part(actual_list,order,unigram_add_one_prob4)
