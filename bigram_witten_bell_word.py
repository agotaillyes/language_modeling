...
##    print 'z list'
##    print sorted(z_list.iteritems(),key=lambda (k,v):v,reverse=True)
...
##    print sorted(train_token_list_first.iteritems(),key=lambda (k,v):v,reverse=True)
...
##    print sorted(train_token_list.iteritems(),key=lambda (k,v):v,reverse=True)
...
##    print sorted(unigram_word_counter_train.iteritems(),key=lambda (k,v):v,reverse=True)
    ...
    train_unigram_witten_bell = train_word_ngram(bigram_witten_bell)    
    test_unigram_witten_bell = test_part(bigram_word_counter_test)   
    
    ranked_train = convert_train_to_rank(train_unigram_witten_bell)
    
    all_test_bigrams_nr = sum(bigram_word_counter_test.values())
    
    result= result_list(test_unigram_witten_bell,ranked_train,all_test_bigrams_nr)
    
##    print 'witten-bell'
##    print sorted(bigram_witten_bell.iteritems(),key=lambda (k,v):v,reverse=False)
    
##    print '~' * 80
##    print 'bigram witten-bell probability'
